...
<div class="index-2">
        ...
        <span class="text2">个人履历</span><input type="text" name="personaltext" id="personaltext" class="column5">
        <span class="text2">家庭关系信息</span><input type="text" name="familytext" id="familytext" class="column5">
        <span class="text2">备注</span><input type="text" name="note" id="note" class="column5">

        <div class="test-item"><button class="but" type="button" id="testBtn">确认登记</button></div>
    </div>
        </form>
</span>
</body>
